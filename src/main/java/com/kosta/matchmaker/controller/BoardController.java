...
public class BoardController {
	...
	public String listAll(@PathVariable("bno") int bno, @ModelAttribute("cri") SearchCriteria cri, Model model)
		...
		// best게시물용 추가코드
		model.addAttribute("mHit", service.maximumHit(bno));
		model.addAttribute("mLike", service.maximumLike(bno));
		model.addAttribute("mReply", service.maximumReply(bno));
		// ----------------
	...
	public String freeWrite(@PathVariable("bno") int bno, RedirectAttributes rttr, FreeBoardVO article)
			throws Exception {
		article.setBno(bno);
	...
	public String refWrite(@PathVariable("bno") int bno, RedirectAttributes rttr, ReferenceBoardVO article)
			throws Exception {
		article.setBno(bno);
		service.register(article);
	...
	public List<String> getAttach(@PathVariable("bno") int bno, @PathVariable("ano") Integer ano) throws Exception {
